...
import { sendContactEmail, sendOrderPlacedEmailToAdmin, sendOrderPlacedEmailToCustomer } from "../utils/emails.js";
...
indexRouter.post("/order/:juiceID", async(req, res) => {
    ...
    await sendOrderPlacedEmailToAdmin(process.env.EMAIL_SENDER, req.user.email, req.body.address, req.body.phoneNumber, juice);
